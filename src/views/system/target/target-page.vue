...
<template>
  <div class="root-container" >
    <el-row justify="space-between">
      ...
      <el-col :span="4"><el-button icon="plus" type="primary" size="large" @click="dialog = true">添加规划目标</el-button></el-col>
    </el-row>

    <el-card v-for="item in target" :key="item.id" class="assessment-card" style="margin-top: 20px;margin-bottom: 20px">
      <el-row>
      ...
      <el-row>
        <p><el-icon style="margin-right: 5px"><Finished/></el-icon>截止时间{{item.finish_date}}</p>
      </el-row>
        ...
        <el-row>
          ...
          <el-col :span="10" :offset="2">
            <el-form-item label="截止日期" class="target-form-item">
              <el-date-picker v-model="targetForm.finish_date" type="date" placeholder="请选择截止日期" size="large"/>
            </el-form-item>
          </el-col>
        </el-row>
